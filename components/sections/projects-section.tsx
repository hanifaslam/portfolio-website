...
export default function ProjectsSection() {
  const projects: ProjectCardProps[] = [
    ...
    },
    {
      ...
      previewUrl: "https://www.figma.com/file/flexy-design",
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mt-16">
            <Link href="/projects">
              <Button
                className="rounded-none border-4 border-black bg-hot-red text-black hover:bg-black hover:text-white font-bold px-8 py-6 h-auto transform rotate-1 transition-transform duration-300 hover:rotate-0 hover:translate-y-[-4px]"
